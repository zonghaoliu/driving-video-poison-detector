...
image, while overall visual realism is preserved:
  - Blurring of vehicles, pedestrians, traffic lights.
...
HARD RULES YOU MUST FOLLOW:
  ...
  3. Scores >= 0.5 require a concrete, severe failure; if you are unsure
     whether a finding is severe, score it at most 0.2.
  4. Be conservative. Most real clips are clean. A score of 0.0 for a
     whole category is the expected outcome on a clean clip.
"""
